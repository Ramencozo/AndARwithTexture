...
public class CustomActivity extends AndARActivity {
	...
	public static Bitmap explain02Bitmap;
	public static Bitmap explain03Bitmap;
	
	CustomObject someObject;
	CustomObject02 someObject02;
	CustomObject03 someObject03;
	ARToolkit artoolkit;
	@Override
	public void onCreate(Bundle savedInstanceState) {
		...
		bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.explain01);
		explain02Bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.explain02);
		explain03Bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.explain03);
		...
		try {
			...
			someObject = new CustomObject("test", "marker_o.patt", 80.0, new double[]{0,0});
			artoolkit.registerARObject(someObject);

			someObject02 = new CustomObject02("test", "marker_p.patt", 80.0, new double[]{0,0});
			artoolkit.registerARObject(someObject02);
			
			someObject03 = new CustomObject03("test", "marker_r.patt", 80.0, new double[]{0,0});
			artoolkit.registerARObject(someObject03);
